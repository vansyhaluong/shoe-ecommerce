...
<div class="container mx-auto px-4 py-12">
    <div class="mb-12">
        <h1 class="text-4xl font-black text-dark mb-2 tracking-tight">Admin <span class="text-indigo-600">Dashboard</span></h1>
        <p class="text-slate-500 font-medium italic">Chào mừng quay trở lại! Dưới đây là tình hình kinh doanh của cửa hàng.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
        <div class="bg-white p-8 rounded-[2rem] shadow-sm border border-slate-100 group hover:bg-indigo-600 transition-all duration-500">
            ...
            <p class="text-slate-400 font-bold text-xs uppercase tracking-widest mb-1 group-hover:text-indigo-200">Doanh thu (Giao xong)</p>
            <h3 class="text-2xl font-black text-dark group-hover:text-white"><?= format_price($total_revenue) ?></h3>
        </div>
        ...
        <div class="bg-white p-8 rounded-[2rem] shadow-sm border border-slate-100 group hover:bg-emerald-600 transition-all duration-500">
            ...
            <p class="text-slate-400 font-bold text-xs uppercase tracking-widest mb-1 group-hover:text-emerald-200">Tổng đơn hàng</p>
            <h3 class="text-2xl font-black text-dark group-hover:text-white"><?= $total_orders ?> đơn</h3>
        </div>
        ...
        <div class="bg-white p-8 rounded-[2rem] shadow-sm border border-slate-100 group hover:bg-amber-600 transition-all duration-500">
            ...
            <p class="text-slate-400 font-bold text-xs uppercase tracking-widest mb-1 group-hover:text-amber-200">Sản phẩm</p>
            <h3 class="text-2xl font-black text-dark group-hover:text-white"><?= $total_products ?> mẫu</h3>
        </div>
        ...
        <div class="bg-white p-8 rounded-[2rem] shadow-sm border border-slate-100 group hover:bg-blue-600 transition-all duration-500">
            ...
            <p class="text-slate-400 font-bold text-xs uppercase tracking-widest mb-1 group-hover:text-blue-200">Khách hàng</p>
            <h3 class="text-2xl font-black text-dark group-hover:text-white"><?= $total_users ?> thành viên</h3>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div class="lg:col-span-1 space-y-6">
            <h4 class="text-xl font-black text-dark italic uppercase tracking-tight">Thao tác nhanh</h4>
            <div class="flex flex-col gap-4">
                <a href="admin_product_form.php" class="flex items-center gap-4 bg-white p-6 rounded-3xl border border-slate-100 hover:border-indigo-600 hover:shadow-xl hover:shadow-indigo-500/10 transition-all group">
                    ...
                    <span class="font-bold text-dark italic">Thêm sản phẩm mới</span>
                </a>
                <a href="admin_products.php" class="flex items-center gap-4 bg-white p-6 rounded-3xl border border-slate-100 hover:border-indigo-600 hover:shadow-xl hover:shadow-indigo-500/10 transition-all group">
                    ...
                    <span class="font-bold text-dark italic">Quản lý danh sách giày</span>
                </a>
                <a href="admin_orders.php" class="flex items-center gap-4 bg-white p-6 rounded-3xl border border-slate-100 hover:border-indigo-600 hover:shadow-xl hover:shadow-indigo-500/10 transition-all group">
                    ...
                    <span class="font-bold text-dark italic">Xem danh sách đơn hàng</span>
                </a>
                <a href="admin_brands.php" class="flex items-center gap-4 bg-white p-6 rounded-3xl border border-slate-100 hover:border-indigo-600 hover:shadow-xl hover:shadow-indigo-500/10 transition-all group">
                    ...
                    <span class="font-bold text-dark italic">Quản lý Thương hiệu</span>
                </a>
                <a href="admin_categories.php" class="flex items-center gap-4 bg-white p-6 rounded-3xl border border-slate-100 hover:border-indigo-600 hover:shadow-xl hover:shadow-indigo-500/10 transition-all group">
                    ...
                    <span class="font-bold text-dark italic">Quản lý Danh mục</span>
                </a>
            </div>
        </div>
        ...
        <div class="lg:col-span-2 space-y-6">
            <h4 class="text-xl font-black text-dark italic uppercase tracking-tight">Đơn hàng mới nhất</h4>
            <div class="bg-white rounded-[2rem] shadow-sm border border-slate-100 overflow-hidden">
                <table class="w-full text-left">
                    <thead class="bg-slate-50 border-b border-slate-100">
                        <tr>
                            <th class="px-8 py-4 font-black text-[10px] uppercase tracking-widest text-slate-400">Mã</th>
                            <th class="px-8 py-4 font-black text-[10px] uppercase tracking-widest text-slate-400">Khách hàng</th>
                            <th class="px-8 py-4 font-black text-[10px] uppercase tracking-widest text-slate-400">Tiền</th>
                            <th class="px-8 py-4 font-black text-[10px] uppercase tracking-widest text-slate-400">Trạng thái</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-slate-50">
                        <?php foreach($recent_orders as $o): ?>
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            <td class="px-8 py-5 font-bold text-dark text-sm">#<?= $o['id'] ?></td>
                            <td class="px-8 py-5 font-bold text-dark text-sm"><?= htmlspecialchars($o['shipping_name']) ?></td>
                            <td class="px-8 py-5 font-black text-indigo-600 text-sm"><?= format_price($o['total_amount']) ?></td>
                            <td class="px-8 py-5">
                                <span class="px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-widest bg-amber-100 text-amber-700">
                                    <?= $o['status'] ?>
                                </span>
                            </td>
                        </tr>
                ...
                <div class="p-6 bg-slate-50/50 text-center">
                    <a href="admin_orders.php" class="text-xs font-black text-indigo-600 uppercase tracking-widest hover:underline">Xem tất cả đơn hàng</a>
                </div>
            </div>
        </div>
    </div>
